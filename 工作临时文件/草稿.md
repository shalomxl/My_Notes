...
docker build -t monster_engineer_back .

记录项目经过，然后连接到各个知识点，再一一完善
...
* 3664是将属性进行代币化，属性值可以交易，升级等操作类似代币转账，我们因为要与游戏进行交互，所以去掉了这个功能，加上了Loot的概念在里面
...
游戏将所有的属性数据传过来(包括基础属性ID value 和 技能属性ID)
