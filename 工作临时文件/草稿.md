...
0xEb18De604086786Ff147d0165cefa79C4b09d71F
...
0x6DD9ed3fABD8Dd75C0183656925bF86E61A92fa6
...
```graphql
{
  token(id:"0xc31beb9aa10e87429e3ced78edf725821671efc6") {
    totalSupply
    holdCount
  }
}
...
```graphql
{
  accountSnapshots(first: 1,orderBy: timestamp, orderDirection: desc,where: {account_: {
    contractAddress: "%s", 
    userAddress: "%s"
    },timestamp_lte:%s}) {
    balance
...
```graphql
{
  accountSnapshotERC721S(first: 1,orderBy: timestamp, orderDirection: desc,
    where: {account_: {
