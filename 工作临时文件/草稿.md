...
# 节点启动命令
/1.5T/bsc/build/bin/geth --config /1.5T/bsc/config.toml --http --ws --graphql --syncmode fast --datadir /1.5T/bscNode --snapshot=false  --cache 8000 --rpc.allow-unprotected-txs --txlookuplimit 2350000
```